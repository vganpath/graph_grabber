...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(820, 810, 111, 101))
        ...
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(930, 810, 271, 101))
        ...
        self.gridLayoutWidget_5.setGeometry(QtCore.QRect(850, 920, 391, 58))
        self.gridLayoutWidget_5.setObjectName("gridLayoutWidget_5")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.gridLayoutWidget_5)
        self.gridLayout_5.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.btn_BottomLeft = QtWidgets.QPushButton(self.gridLayoutWidget_5)
        self.btn_BottomLeft.setObjectName("btn_BottomLeft")
        self.gridLayout_5.addWidget(self.btn_BottomLeft, 0, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.btn_GetDataPoints, 0, 2, 1, 1)
        self.btn_TopRight = QtWidgets.QPushButton(self.gridLayoutWidget_5)
        self.btn_TopRight.setObjectName("btn_TopRight")
        self.gridLayout_5.addWidget(self.btn_TopRight, 1, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.lineEdit_DataPoints, 0, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.label_pixel_color, 1, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.lineEdit_Rounding, 1, 3, 1, 1)
        ...
        self.btn_ClearTable.setGeometry(QtCore.QRect(1350, 810, 89, 25))
        self.btn_ClearTable.setObjectName("btn_ClearTable")
        self.btn_CopyData = QtWidgets.QPushButton(self.centralwidget)
        self.btn_CopyData.setGeometry(QtCore.QRect(1458, 810, 71, 25))
